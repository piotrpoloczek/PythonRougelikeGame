...
from board.board_model import put_player_on_board, clear_place_on_board, check_new_coordinates
...
def move(character, direction, board):
    ...
    check_new_coordinates(new_coordinates_list, board)
    clear_place_on_board(board, character_old_coordinates)
