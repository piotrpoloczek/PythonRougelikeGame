...
from entities.character.player.player_const import PLAYER_ICON, HP, ATTACK, LVL, EXPERIENCE
...
def create_player():
    ...
    player = create_character(TYPE_PLAYER, name, player_coordinate_list, PLAYER_ICON, ATTACK, HP, LVL, EXPERIENCE)
